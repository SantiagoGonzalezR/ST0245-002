...
/**
 * Dar solucion taller numero 9 Se recomienda hacer una clase o metodo main que
 * instancie esta clase de manera que sirva como test y desarrolle las
 * actividades y cuestiones presentadas en el taller. En esta clase se hará uso
 * total de la clase HashMap:
 * 
 * @see <a href=
...
public class Taller9 {
     ...
     * @param value    es el valor asociado a la llave key El metodo agregara un
     *                 nuevo valor a empresas con los atributos key y value.
     */

 ...
 *
 * @author Mauricio Toro, Mateo Agudelo, Daniel Mesa, Santiago Gonzalez Rodriguez, Mariana Vasquez Escobar
 */
...
public class DigraphAL extends Digraph {
    ...
    */
    public DigraphAL(int size) {
        super(size);
        nodo = new ArrayList<LinkedList<Pair<Integer,Integer>>>();
    ...
    */
    public void addArc(int source, int destination, int weight) {
         nodo.get(source).add(new Pair<Integer,Integer>(destination,weight));
    }

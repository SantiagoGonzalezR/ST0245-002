...
class SeparadorDeMatrices { //proyecto
    public static Pair<Float, Float> elGiniPorVariableQueRecomiendaDaniela(String[][] m, int variable,  String valor){
        ...
        float elGiniCuandoEsVerdadero = sacarElGiniDeUnaMatriz(pareja.getKey());
    ...
    private static void meterLasFilasQueCorrespondenACadaMatriz(String[][] m, String[][] matrizCuandoDaVerdadero, String[][] matrizCuandoDaFalso, int variable, String valor){ // Xtreme Programming
    ...
    public static Pair<String[][], String[][]> separador(String[][] m, int variable, String valor){
        ...
        meterLasFilasQueCorrespondenACadaMatriz(m,matrizCuandoDaVerdadero,matrizCuandoDaFalso, variable, valor);
